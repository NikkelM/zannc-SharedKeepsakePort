...
gods.CreateKeepsake({
    ...
    Keepsake = {
        ...
        trayDescription = "Gain{#UpgradeFormat}{$TooltipData.ExtractData." ..
            guid .. "-TooltipFastClearDodgeBonus:P} {#Prev}{$Keywords.Dodge} chance and {#BoldFormatGraft}move {#Prev}speed each time you quickly clear an {$Keywords.EncounterAlt}.\n{#StatFormat}Dodge Chance & Move Speed: {#UpgradeFormat}{$TooltipData.ExtractData.TooltipAccumulatedBonus:P}{#Prev}",
